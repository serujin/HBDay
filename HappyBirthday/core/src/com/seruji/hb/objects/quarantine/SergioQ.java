...
public class SergioQ extends GameObject {

	private int draw;
	private int rotation;
	
	public SergioQ(int x, int y, int xSize, int ySize, SpriteBatch batch) {
		super(x, y, xSize, ySize, batch);
		sprites = Utils.getSprites(Assets.quarantineSprites, 2, 4);
		draw = 0;
		rotation = 40;
	}
